...
public class CalculatorOnline {
    ...
    public void openChromeBrowserAndStartApplication() {
        System.setProperty("webdriver.chrome.driver", "/Users/agungenrico/Documents/practice/calculator-iframe-cucumber/chromedriver");
    ...
    public void takeScreenShot(String position) throws IOException {
        ...
        if (position.equals("result")) {
            ...
            croppedScreenShot = fullImg.getSubimage(32, 32, 410, 60);
            screenshotLocation = new File("result.png");
        } else {
            croppedScreenShot = fullImg.getSubimage(368, 140, 72, 70);
